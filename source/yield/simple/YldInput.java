...
/**
 * Essa classe contém todas as informações sobre o input do teclado da janela do
 * jogo
 */
public final class YldInput implements KeyListener {

    private static HashSet<String> keysSet;

    public YldInput() {
        keysSet = new HashSet<String>();
        YldMouse mouse = new YldMouse();
        SimpleYield.getFrame().addMouseListener(mouse);
        SimpleYield.getFrame().addMouseWheelListener(mouse);
    }
     ...
     * @return the keysSet
     */
    public static HashSet<String> getKeysSet() {
        return keysSet;
    }
     ...
     */
    public static void setKeysSet(HashSet<String> keysSet) {
